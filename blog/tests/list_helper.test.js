...
describe.skip('test help methods', () => {
  describe('dummy', () => {
  ...
  describe('total likes', () => {
    ...
    test('of a bbigger list is calculated right', () => {
  ...
  describe('favourite blog', () => {
    test('of empty list is null', () => {
      const blogs = []
      expect(listHelper.favouriteBlog(blogs)).toBe(null)
    })

    test('should return blog object with most likes', () => {
      const blogs = testBlogs
      expect(listHelper.favouriteBlog(blogs)).toEqual(testBlogs[2])
    })
  })
